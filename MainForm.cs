...
namespace ExportDataToXML
{
	...
	public partial class MainForm : Form
	{
		...
		public void TampilSemua(DataTable tabel)
		{
            ...
            tampil.Columns[0].HeaderText = "Nomor Induk";
            tampil.Columns[0].Width = 53; //tipe cd
		...
		void Button1Click(object sender, EventArgs e) //Tombol Export to XML
		{
		...
		void Button2Click(object sender, EventArgs e) //Tombol Refresh Data
		{
			bacaData bc = new bacaData();
			tabel = bc.bacaDataSemua();
			TampilSemua(tabel);
